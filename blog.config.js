...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是inybluerabbit, 我什么都搞点,我也在不断地认识自己,welcome to my space🏝️',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'inybluerabbit', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || 'record求学与自我', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.inybluerabbit.space/en', // 网站地址
